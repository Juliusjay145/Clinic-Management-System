...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><i class="fa fa-plus" style="font-size: 35px; color: red"></i> <h4 style="margin-top: -39px; margin-left: 30px">Clinic Management</h4></a>
            </div>
  ...
  <li class="active">Data</li>
	...
	<script src="{{ url('/js/easypiechart-data.js') }}"></script>
	 ...
	 <script src="{{ url('/js/Lightweight-Chart/jquery.chart.js') }}"></script>
